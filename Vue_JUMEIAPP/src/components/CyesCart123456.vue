<template>
  <div style="background: #f5f5f5;">
    <div>
      ...
      <div class="groups">
        <div>
          <div class="group" v-for="(item,index) in cartList" :key="index">
            <div class="group-header">
              <span class="check-box-checked"></span>
              <div class="group-title" v-text="item.merchant"></div>
            ...
            <div class="group-content">
              <div class="item">
                ...
                <div class="item-content">
                  <div class="img-title">
                    <div class="img-wrap">
                      <img :src="item.data.imgUrl" alt="Hold live 幽兰之情唇釉 一盒让李佳琦都说OMG的唇釉">
                    </div>
                    <div class="text-wrap">
                      <span class="title" v-text="item.data.title"></span>
                      <div class="sub-title-1">
                        <span v-text="item.data.attr_desc"></span>
                        <span>×1</span>
                      </div>
                    ...
                    <div class="text-wrap" style="display: none;">
                      ...
                      <div class="price-edit">
                        ...
                        <div class="actions">
                          ...
                          <span class="action-finish">完成</span>
                        </div>
                      </div>
                    </div>
                  </div>
              ...
              <!-- <div>
                                <div class="item">
                                    ...
                                    <div class="item-content">
                                        <div class="img-title">
                                            <div class="img-wrap"> <img src="https://p2.jmstatic.com//product/197/947/df4651250197947824_std/s_df4651250197947824_200_200.jpg" alt="素萃 颈部护理原液6瓶装 和颈纹说再见"> </div>
                                            <div class="text-wrap">
                                                <span class="title"> 素萃 颈部护理原液6瓶装 和颈纹说再见 </span>
                                                <div class="sub-title-1">
                                                    <span>颈部护理原液 10g*6</span>
                                                    <span>×1</span>
                                                </div>
                                                <div class="price-edit">
                                            ...
                                            <div class="text-wrap" style="display: none;">
                                                ...
                                                <div class="price-edit">
                                                    <span class="price editing"> ¥68 </span>
                                                    <div class="actions">
                                                        <span class="delete">删除</span>
                                                        <span class="gap-line"></span>
                                                        <span class="action-finish">完成</span>
        ...
        <!-- <div>
                    <div class="group">
                        <div class="group-header">
                            <span class="check-box-checked"></span>
                            <div class="group-title"> 达信永金发货 </div>
                            <span class="arrow-wrapper">
                                <span></span>
                            </span>
                        </div>
                        ...
                        <div class="group-content">
                            <div>
                                <div class="item">
                                    ...
                                    <div class="item-content">
                                        <div class="img-title">
                                            <div class="img-wrap"> <img src="https://p0.jmstatic.com//product/198/411/df4900898198411175_std/s_df4900898198411175_200_200.jpg" alt="朵拉朵尚多肽修护电动按摩眼霜20g"> </div>
                                            <div class="text-wrap">
                                                <span class="title"> 朵拉朵尚多肽修护电动按摩眼霜20g </span>
                                                <div class="sub-title-1">
                                                    <span>电动按摩眼霜20g</span>
                                                    <span>×1</span>
                                                </div>
                                            ...
                                            <div class="text-wrap" style="display: none;">
                                                ...
                                                <div class="price-edit">
                                                    <span class="price editing"> ¥89 </span>
                                                    <div class="actions">
                                                        <span class="delete">删除</span>
                                                        <span class="gap-line"></span>
                                                        <span class="action-finish">完成</span>
